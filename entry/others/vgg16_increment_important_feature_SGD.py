...
args['base_dir'] = "model/vgg16_sgd_incremental_lw_nooverlap_pretrained/fix"
...
for i in range(n):
    ...
    file_name = (
        "scores_incremental_overlap_v4_important_feature_SGD_lw_pretrained.pkl"
        if overlap  
        else "scores_incremental_v4_important_feature_SGD_lw_pretrained.pkl"
    )
