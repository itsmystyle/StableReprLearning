...
for i in range(n):
    ...
    for j in range(1, n_model):
        ...
        start = j * step_size // 2 if overlap else 0 # increment case
    ...
    file_name = (
        "scores_incremental_overlap_embedding_regularize_v5.pkl"
        if overlap
        else "scores_incremental_embedding_regularize_v14.pkl"
    )
