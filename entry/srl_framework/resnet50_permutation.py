...
args["base_dir"] = "model/resnet50_adam_permutation_v20_pretrained/fix"
...
for i in range(n):
    ...
    file_name = "results/scores_resnet50_v20_important_feature_ADAM_permutation_pretrained.pkl"
